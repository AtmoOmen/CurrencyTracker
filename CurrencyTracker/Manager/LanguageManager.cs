            ...
            languageResources = new Dictionary<string, Dictionary<string, string>>
            {
                // 简体中文
                {
                    "ChineseSimplified", new Dictionary<string, string>
                    {
                        ...
                        { "MergeTransactionsLabel2", "双向合并 (原)" },
                        { "MergeTransactionsLabel3", "单项合并 (实验)" },
                        { "MergeTransactionsLabel4", "手动合并" },
                        ...
                        "合并后记录时间、总数取被合并记录中最新一条的数值，收支则为彼此相加\n\n" +
                ...
                // English
                {
                    "English", new Dictionary<string, string>
                    {
                        ...
                        { "MergeTransactionsLabel2", "Two-Way Merge [ORIG.]" },
                        { "MergeTransactionsLabel3", "One-Way Merge [EXPT.]" },
                        { "MergeTransactionsLabel4", "Manual Merge" },
                        { "MergeTransactionsHelp", "Please enter a threshold" },
                        { "MergeTransactionsHelp1", "Merged " },
                        { "MergeTransactionsHelp2", " records." },
                        { "MergeTransactionsHelp3", "Merge transactions under the currently selected currency with the same location, adjacent to each other, and with a Change below the threshold.\n" +
                        ...
                        "One-Way Merge: Transactions with Changes in positive and negative are separately calculated when merging adjacent ones.\n" +
                        "Two-Way Merge: Transactions with Changes in positive and negative are calculated together when merging adjacent ones.\n\n" },
                        ...
                        { "TrackModeLabel2", "Chat Mode [EXPT.]" },
